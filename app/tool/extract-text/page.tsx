...
export default function ExtractText() {
    ...
    return (
        <div className="flex-1 flex flex-col">
            <div className="bg-gradient-to-r from-violet-600 to-purple-700 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    <div className="w-8 h-8 bg-white/20 rounded-sm flex items-center justify-center flex-shrink-0">
                        <img src="/tools/extract-text.svg" alt="" className="w-5 h-5" />
                    </div>
                    <div className="flex-1 min-w-0">
                        <h1 className="text-base font-semibold leading-tight">Extract Text</h1>
                        <p className="text-xs opacity-75 leading-tight">Extract all text content from any PDF file</p>
                    </div>
            ...
            <div className="flex-1 px-4 md:px-8 py-5">
                <div className="max-w-5xl mx-auto">
                        ...
                        <div className="max-w-2xl mx-auto space-y-6">
                            ...
                            {step === Step.IDLE && !extractedText && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <button onClick={startExtract} className="w-full py-2.5 rounded-sm bg-violet-600 text-white font-semibold text-sm hover:bg-violet-700 transition-colors shadow-sm">
                                        Extract Text
                                    </button>
                                </div>
                            )}
                            ...
                            {step === Step.DONE && extractedText !== null && (
                                <div className="flex flex-col gap-4">
                                    <div className="flex items-center justify-between">
                                        ...
                                        <button onClick={downloadText} className="inline-flex items-center gap-2 px-4 py-2 rounded-sm bg-violet-600 text-white text-sm font-semibold hover:bg-violet-700 transition-colors shadow-sm">
                                    ...
                                    <pre className="w-full max-h-96 overflow-auto bg-slate-50 border border-slate-200 rounded-sm p-4 text-xs text-slate-700 whitespace-pre-wrap font-mono leading-relaxed dark:bg-slate-900 dark:border-slate-700 dark:text-slate-200">
                    ...
                    <ToolSeoSection
                        ...
                        features={[
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-violet-600 dark:text-violet-400"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></svg>, title: 'In-browser preview', description: 'See the extracted text immediately without downloading anything.' },
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-violet-600 dark:text-violet-400"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>, title: 'Download as .txt', description: 'Save the extracted content as a plain text file with one click.' },
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-violet-600 dark:text-violet-400"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>, title: 'Position-sorted', description: 'Text is extracted in reading order (left-to-right, top-to-bottom).' },
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-violet-600 dark:text-violet-400"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, title: 'Instant results', description: 'Text extraction from most PDFs completes in under a second.' },
                        ]}
                        faqs={[
            ...
            <div className="sticky bottom-0 z-30 flex-shrink-0 bg-white border-t border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <button disabled={activeStep === 1 || !fileData} onClick={() => setActiveStep(a => a + 1)} className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-sm bg-violet-600 text-white text-sm font-semibold hover:bg-violet-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm">
                        Next
