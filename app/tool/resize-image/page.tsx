                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-2.5 py-1.5 rounded border border-slate-200 text-sm outline-none focus:border-teal-400 focus:ring-2 focus:ring-teal-50 dark:border-slate-700"
                                    />
                                </div>
                                <div className="flex flex-col gap-1.5">
                            ...
                            {step === Step.IDLE && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <button onClick={startResize}
                                        className="w-full py-2.5 rounded bg-teal-500 text-white font-semibold text-sm hover:bg-teal-600 transition-colors shadow-sm">
                                        Resize & Download
                                    </button>
            ...
            <div className="sticky bottom-0 z-30 flex-shrink-0 bg-white border-t border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <button disabled={activeStep === 2 || !fileData} onClick={() => setActiveStep(a => a + 1)}
                        className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded bg-teal-500 text-white text-sm font-semibold hover:bg-teal-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm">
