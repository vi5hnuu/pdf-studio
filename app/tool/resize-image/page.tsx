...
export default function ResizeImage() {
    ...
    return (
        <div className="flex-1 flex flex-col">
            <div className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    <div className="w-8 h-8 bg-white/20 rounded-sm flex items-center justify-center flex-shrink-0">
                        <img src="/tools/resize-image.svg" alt="" className="w-5 h-5" />
                    </div>
                    <div className="flex-1 min-w-0">
                        <h1 className="text-base font-semibold leading-tight">Resize Image</h1>
                        <p className="text-xs opacity-75 leading-tight">Change image dimensions to exact pixel values</p>
                    </div>
            ...
            <div className="flex-1 px-4 md:px-8 py-5">
                <div className="max-w-5xl mx-auto">
                    ...
                    {activeStep === 1 && (
                        <div className="max-w-sm mx-auto space-y-6 py-4">
                            ...
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-sm border-2 transition-all ${maintainAspectRatio ? 'border-teal-500 bg-teal-50 dark:bg-teal-900/25' : 'border-slate-200 dark:border-slate-700'}`}
                            >
                                <div className={`w-5 h-5 rounded-sm flex items-center justify-center flex-shrink-0 transition-colors ${maintainAspectRatio ? 'bg-teal-500' : 'bg-slate-200'}`}>
                                    {maintainAspectRatio && (
                            ...
                            <div className="bg-teal-50 border border-teal-200 rounded-sm px-4 py-3 text-xs text-teal-800 dark:bg-teal-900/20 dark:border-teal-800 dark:text-teal-300">
                                {maintainAspectRatio
                            ...
                            {step === Step.IDLE && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <button onClick={startResize}
                                        className="w-full py-2.5 rounded-sm bg-teal-500 text-white font-semibold text-sm hover:bg-teal-600 transition-colors shadow-sm">
                                        Resize & Download
                                    </button>
                    ...
                    <ToolSeoSection
                        ...
                        features={[
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-teal-600 dark:text-teal-400"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>, title: 'Exact pixel control', description: 'Specify exact width and/or height in pixels.' },
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-teal-600 dark:text-teal-400"><path d="M18 20V10M12 20V4M6 20v-6"/></svg>, title: 'Aspect ratio lock', description: 'Provide one dimension to scale proportionally without distortion.' },
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-teal-600 dark:text-teal-400"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="m21 15-5-5L5 21"/></svg>, title: 'All common formats', description: 'Accepts JPEG, PNG, WebP, BMP, and GIF images.' },
            ...
            <div className="sticky bottom-0 z-30 flex-shrink-0 bg-white border-t border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <button disabled={activeStep === 2 || !fileData} onClick={() => setActiveStep(a => a + 1)}
                        className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-sm bg-teal-500 text-white text-sm font-semibold hover:bg-teal-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm">
