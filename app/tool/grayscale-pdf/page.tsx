        ...
        <div className="flex-1 flex flex-col">
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex items-center gap-4 p-4 bg-slate-50 dark:bg-slate-700/50 rounded-sm border border-slate-200 dark:border-slate-600 dark:bg-slate-900 dark:border-slate-700">
                                        <div className="flex gap-2">
                                            <div className="w-8 h-10 rounded-sm bg-gradient-to-b from-blue-400 to-red-400" />
                                            <div className="w-8 h-10 rounded-sm bg-gradient-to-b from-green-400 to-yellow-400" />
                                        </div>
                                        ...
                                        <div className="flex gap-2">
                                            <div className="w-8 h-10 rounded-sm bg-gradient-to-b from-gray-300 to-gray-700" />
                                            <div className="w-8 h-10 rounded-sm bg-gradient-to-b from-gray-200 to-gray-500" />
                                        </div>
                                    ...
                                    <button onClick={startGrayscale} className="w-full py-2.5 rounded-sm bg-zinc-700 text-white font-semibold text-sm hover:bg-zinc-800 transition-colors shadow-sm">
            ...
            <div className="sticky bottom-0 z-30 flex-shrink-0 bg-white border-t border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <button disabled={activeStep === 1 || !fileData} onClick={() => setActiveStep(a => a + 1)} className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-sm bg-zinc-700 text-white text-sm font-semibold hover:bg-zinc-800 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm">
                        Next
