        ...
        <div className="w-full max-w-md mx-auto flex flex-col gap-6 py-10 px-4">
            ...
            {step === Step.IDLE && (
                <div className="flex flex-col gap-4">
                    <button onClick={startUnProtect} className="w-full py-2.5 rounded-sm bg-yellow-500 text-white font-semibold text-sm hover:bg-yellow-600 active:bg-yellow-700 transition-colors shadow-sm">
                        Unlock PDF
                    </button>
