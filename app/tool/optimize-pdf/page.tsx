...
export default function OptimizePdf() {
    ...
    return (
        <div className="flex-1 flex flex-col">
            <div className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    <div className="w-8 h-8 bg-white/20 rounded-sm flex items-center justify-center flex-shrink-0">
                        <img src="/tools/optimize-pdf.svg" alt="" className="w-5 h-5" />
                    </div>
                    <div className="flex-1 min-w-0">
                        <h1 className="text-base font-semibold leading-tight">Optimize PDF</h1>
                        <p className="text-xs opacity-75 leading-tight">Clean PDF structure — remove redundant data and embedded thumbnails</p>
                    </div>
                        ...
                        <div className="max-w-md mx-auto flex flex-col gap-6 py-8">
                            ...
                            {step === Step.IDLE && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    {/* What gets optimized */}
                                    <div className="bg-emerald-50 rounded-sm border border-emerald-200 px-4 py-4 space-y-3 dark:bg-emerald-900/20 dark:border-emerald-800">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-2.5 py-1.5 rounded-sm border border-slate-200 text-sm outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 dark:border-slate-700"
                                        />
                                    </div>
                                    <button
                                        onClick={startOptimize}
                                        className="w-full py-2.5 rounded-sm bg-emerald-500 text-white font-semibold text-sm hover:bg-emerald-600 transition-colors shadow-sm"
                                    >
                                        Optimize & Download
                                    </button>
            ...
            <div className="sticky bottom-0 z-30 flex-shrink-0 bg-white border-t border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <button
                        ...
                        onClick={() => setActiveStep(a => a + 1)}
                        className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-sm bg-emerald-500 text-white text-sm font-semibold hover:bg-emerald-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm"
                    >
                        Proceed
