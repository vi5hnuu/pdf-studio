...
export default function FilterImage() {
    ...
    async function startFilter() {
        ...
        await runToolRequest({
            url: ToolsApi.filterImage,
            formData,
            fallbackFilename: 'filter-image.png',
            ...
            <div className="bg-gradient-to-r from-purple-600 to-violet-700 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-base font-semibold leading-tight">Filter Image</h1>
                        <p className="text-xs opacity-75 leading-tight">Apply grayscale, sepia, sharpen, vintage and other effects</p>
                    </div>
