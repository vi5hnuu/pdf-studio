...
export default function DeletePages() {
    ...
    return (
        <div className="flex-1 flex flex-col">
            {/* Hero */}
            <div className="bg-gradient-to-r from-rose-600 to-red-700 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    <div className="w-8 h-8 bg-white/20 rounded-sm flex items-center justify-center flex-shrink-0">
                        <img src="/tools/delete-pages.svg" alt="" className="w-5 h-5" />
                    </div>
                    <div className="flex-1 min-w-0">
                        <h1 className="text-base font-semibold leading-tight">Delete Pages</h1>
                        <p className="text-xs opacity-75 leading-tight">Remove unwanted pages from any PDF visually</p>
                    </div>
                            ...
                            >
                                {Array.from({ length: totalPages }, (_, i) => (
                                    <div
                                        ...
                                        className={`relative cursor-pointer rounded-sm border-2 overflow-hidden transition-all ${selectedPages.has(i) ? 'border-rose-500 ring-2 ring-rose-300' : 'border-slate-200 hover:border-slate-400'}`}
                                    >
                        ...
                        <div className="max-w-md mx-auto flex flex-col gap-6 py-8">
                            ...
                            {step === Step.IDLE && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="bg-rose-50 rounded-sm border border-rose-200 px-4 py-3 text-sm text-rose-700 dark:bg-rose-900/20 dark:border-rose-800 dark:text-rose-300">
                                    ...
                                    <button
                                        onClick={startDelete}
                                        className="w-full py-2.5 rounded-sm bg-rose-600 text-white font-semibold text-sm hover:bg-rose-700 transition-colors shadow-sm"
                                    >
            ...
            <div className="sticky bottom-0 z-30 flex-shrink-0 bg-white border-t border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <button
                        ...
                        onClick={() => setActiveStep(a => a + 1)}
                        className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-sm bg-rose-600 text-white text-sm font-semibold hover:bg-rose-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm"
                    >
