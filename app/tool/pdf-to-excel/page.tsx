        ...
        <div className="flex-1 flex flex-col">
            <div className="bg-gradient-to-r from-green-600 to-emerald-700 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    <div className="w-8 h-8 bg-white/20 rounded flex items-center justify-center flex-shrink-0"><img src="/tools/pdf-to-excel.svg" alt="" className="w-5 h-5" /></div>
                            ...
                            {step === Step.IDLE && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input type="text" value={outFileName} onChange={(e: ChangeEvent<HTMLInputElement>) => setOutFileName(e.target.value.trim())} placeholder="spreadsheet" className="w-full px-2.5 py-1.5 rounded border border-slate-200 text-sm outline-none focus:border-green-400 focus:ring-2 focus:ring-green-100 dark:border-slate-700" />
                                    </div>
                                    <button onClick={startConvert} className="w-full py-2.5 rounded bg-green-600 text-white font-semibold text-sm hover:bg-green-700 transition-colors shadow-sm">Convert & Download .xlsx</button>
