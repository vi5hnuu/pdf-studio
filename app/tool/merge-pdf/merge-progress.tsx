...
export function MergeProgress({ files }: { files: FileData[] }) {
    ...
    async function startMerge() {
        ...
        xhr.onerror = () => { setError('Failed to merge PDF files'); setStep(Step.IDLE); };
        ...
        <div className="w-full max-w-md mx-auto flex flex-col gap-6 py-10 px-4">
            ...
            {step === Step.IDLE && (
                <div className="flex flex-col gap-4">
                    ...
                    <p className="text-center text-xs text-slate-400">Your merged file will download automatically</p>
                </div>
            )}
        </div>
    );
