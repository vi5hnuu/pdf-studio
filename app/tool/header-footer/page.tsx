            ...
            <div className="bg-gradient-to-r from-emerald-600 to-teal-700 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                        <h1 className="text-base font-semibold leading-tight">Header &amp; Footer</h1>
                        <p className="text-xs opacity-75 leading-tight">Add custom header and footer text to every page</p>
                    </div>
