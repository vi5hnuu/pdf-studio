...
export default function RemoveBlankPages() {
    ...
    async function startRemove() {
        ...
        setError(null);
        xhr.open('POST', ToolsApi.removeBlankPages, true);
        ...
        xhr.onload = () => {
            ...
            const filename = disp.split('filename=')[1] ?? (outFileName || 'cleaned') + '.pdf';
                ...
                <div className="max-w-5xl mx-auto">
                        ...
                        <div className="max-w-md mx-auto flex flex-col gap-6 py-8">
                            ...
                            {step === Step.IDLE && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <p className="text-center text-xs text-slate-400">Your cleaned PDF will download automatically</p>
                                </div>
                            )}
                        </div>
                    )}
                    ...
                    <ToolSeoSection
                        ...
                        features={[
                            ...
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-amber-600"><circle cx="12" cy="12" r="3"/><path d="M12 1v4M12 19v4M4.22 4.22l2.83 2.83M16.95 16.95l2.83 2.83M1 12h4M19 12h4M4.22 19.78l2.83-2.83M16.95 7.05l2.83-2.83"/></svg>, title: 'Adjustable sensitivity', description: 'Four presets from strict (fully white only) to aggressive (removes sparse pages).' },
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-amber-600"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/></svg>, title: 'Structure preserved', description: 'All text, images, bookmarks and links in non-blank pages are kept intact.' },
                            { icon: <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="text-amber-600"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>, title: 'Free to use', description: 'No account needed — just upload your PDF and download the result.' },
                        ]}
                        faqs={[
