            ...
            <div className="bg-gradient-to-r from-amber-500 to-orange-600 text-white px-4 md:px-8 py-2.5 flex-shrink-0">
                <div className="max-w-5xl mx-auto flex items-center gap-2.5">
                    <div className="w-8 h-8 bg-white/20 rounded-sm flex items-center justify-center flex-shrink-0">
                        <img src="/tools/remove-blank-pages.svg" alt="" className="w-5 h-5" />
                    </div>
                    <div className="flex-1 min-w-0">
                        <h1 className="text-base font-semibold leading-tight">Remove Blank Pages</h1>
                        <p className="text-xs opacity-75 leading-tight">Automatically detect and remove empty pages from your PDF</p>
                    </div>
                        ...
                        <div className="max-w-2xl mx-auto space-y-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {SENSITIVITY_PRESETS.map(({ label, threshold: t, hint, recommended }) => (
                                    <label
                                        key={t}
                                        className={`relative flex flex-col gap-2 p-4 rounded-sm border-2 cursor-pointer transition-all ${threshold === t ? 'border-amber-500 bg-amber-50 dark:bg-amber-900/25 shadow-md' : 'border-slate-200 dark:border-slate-700 hover:border-slate-300 bg-white dark:bg-slate-800'}`}
                                    >
                        ...
                        <div className="max-w-md mx-auto flex flex-col gap-6 py-8">
                            ...
                            {step === Step.IDLE && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="bg-amber-50 rounded-sm border border-amber-200 px-4 py-3 text-sm text-amber-800 dark:bg-amber-900/20 dark:border-amber-800 dark:text-amber-300">
                                    ...
                                    <div className="flex flex-col gap-1.5">
                                        ...
                                        <input
                                            ...
                                            placeholder="cleaned"
                                            className="w-full px-2.5 py-1.5 rounded-sm border border-slate-200 text-sm outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-100 dark:border-slate-700"
                                        />
                                    </div>
                                    <button
                                        onClick={startRemove}
                                        className="w-full py-2.5 rounded-sm bg-amber-500 text-white font-semibold text-sm hover:bg-amber-600 transition-colors shadow-sm"
                                    >
            ...
            <div className="sticky bottom-0 z-30 flex-shrink-0 bg-white border-t border-slate-200 px-6 py-4 dark:bg-slate-800 dark:border-slate-700">
                <div className="max-w-5xl mx-auto flex items-center justify-between">
                    ...
                    <button
                        ...
                        onClick={() => setActiveStep(a => a + 1)}
                        className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-sm bg-amber-500 text-white text-sm font-semibold hover:bg-amber-600 disabled:opacity-40 disabled:cursor-not-allowed transition-colors shadow-sm"
                    >
